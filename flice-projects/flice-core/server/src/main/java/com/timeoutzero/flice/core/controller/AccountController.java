...
public class AccountController {
	...
	public Cookie createToken(@RequestParam String email, @RequestParam String password) {
		
		String token = null;
		
		try {

			token = accountOperations.getTokenOperations().create(email, password, clientId, GrantType.PASSWORD);
