...
public interface CommunityRepository extends CrudRepository<Community, Long>, PagingAndSortingRepository<Community, Long>{

	Community findById(Long id);
	
	List<Community> findByPrivacy(Privacy privacy, Pageable pageable);
